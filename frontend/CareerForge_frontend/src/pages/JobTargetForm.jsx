...
const JobTargetForm = () => {
    ...
    const startMockInterview = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                "/ai_engine/mock-interview/start/",
                {
                    generated_resume_id:
    ...
    const submitInterviewAnswer = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                "/ai_engine/mock-interview/answer/",
                {
                    session_id:
